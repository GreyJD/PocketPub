...
import com.example.cocktailthing.utility.RecipeParser;
...
//      an Integer (int) that represents the number of recipes that use the ingredient
    ...
    protected Integer doInBackground(String... params) {
        ...
        // get the json response from TheCockTailDBApi's Recipe API
        String responseJson = TheCocktailDBApi.searchRecipes(searchTerm);
